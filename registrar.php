                ...
                <div class="col-lg-6">
                  <div class="card-body p-4 p-sm-5">
                    ...
                    <form method="POST" action="model/cadastrar_usuario.php" class="form-body">
                      ...
                      <div class="login-separater text-center mb-4"> <span>OU CRIAR CONTA COM O EMAIL</span>
                        <hr>
                      </div>
                        <div class="row g-3">
                          <div class="col-12 ">
                          ...
                          <div class="col-12">
                            <div class="form-check form-switch">
                              ...
                              <label class="form-check-label" for="flexSwitchCheckChecked">Eu aceito os termos e condições</label>
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="d-grid">
                          ...
                          <div class="col-12">
                            <p class="mb-0">Já tem uma conta? <a href="authentication-signin.html">Fazer login</a></p>
                          </div>
                        </div>
                    </form>
                 </div>
